...
export default function Privileges({ user, hide }) {
    ...
    // List of tab names
    const tabNames = ['Dashboard', 'Customers', 'Vendors', 'Products', 'Sales', 'Purchases', 'Reports', "Expenses", "Employees", 'Accounts', 'Adminstration'];
        ...
        /> back</Typography>
            ...
            {tabNames.map((tabName, index) => (
                <div key={index} style={{
                    ...
                    borderRadius: '5px',
                    cursor: "pointer",
                    backgroundColor: selectedTabs.includes(tabName) ? '#FAF3FF' : 'transparent'
                }}
